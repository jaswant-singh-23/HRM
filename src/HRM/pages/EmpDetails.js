...
const handleDotNet = () => {
  ...
  /////// Get Quizs ///////
	...
	const handleDelete = (data) => {
		...
		console.log(itemId)
		AuthService.deleteEmployeeAccount(itemId).then((response) => {
			console.log(response)
            ...
            <div className="leave-sec">
              <div className="row">
                  <div className="col-12 col-md-12 col-lg-4">
                    <div className="d-flex align-items-center flex-wrap dropdown justify-content-end h-100">
                    ...
                    <tr key={i}>
                      ...
                      <div className="d-flex align-items-center justify-content-center">
                       <Link className="text-light text-decoration-none" to={"/edit-emp/" + data.username}>
                        ...
                        <span className="ms-2 cursor-pointer" onClick={() => handleDelete(data.username)}>
