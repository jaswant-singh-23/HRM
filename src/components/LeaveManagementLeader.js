...
const LeaveManagement = () => {
  ...
  const handleApproved = (items) => {
    ...
    const data = {
      ...
      username: items.username,
      department: items.department,
      teamLeaderResponse: true,
      fromDate: items.fromDate,
      leaderResponse: "Approved",
      toDate: items.toDate,
    };
    userService
      .leaveReplyByTeamLeader(data)
      .then((response) => {
        console.log(response);
        setAddShow(false);
        ...
        <div className="row d-flex justify-content-center mt-5">
          <div className="col-10 col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 profile-badge bg-white p-4">
            <div className="text-center py-4">
              <h2 className=" ">Team Leave Section</h2>
            </div>
            ...
            <Modal centered show={addShow} onHide={handleHideShow}>
                ...
                <div>
                  <div>
                    ...
                    <p className="mb-2">
                      ...
                      <b>{moment(openLeave.fromDate).format("DD-MMM-YYYY")}</b>{" "}
                      to <b>{moment(openLeave.toDate).format("DD-MMM-YYYY")}</b>
              ...
              <Modal.Footer>
                <Button
                  ...
                  onClick={handleRejected(openLeave)}
                >
                  Reject
                </Button>
                <Button
